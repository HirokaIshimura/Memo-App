        ...
        <div class="card rounded login-card-width shadow">
            <div class="card-body">
                ...
                <div class="row mt-3">
                    <div class="offset-2 col-8 offset-2">
                        ...
                        <label class="input-group w-100">
                            ...
                            <input type="password" name="password" class="form-control" placeholder="パスワード" value="{{ old('email') }}" autocomplete="off" />
                        </label>
                ...
                <div class="mt-5">
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="{{ route("register") }}" class="text-success">アカウントを作成</a>
                    </div>
                </div>
